...
function flip(e) {
    if (flippedTiles < 2) {
        ...
        if (e.target.classList.contains("game-card")) {
            //start timer on click if not already started
            if (gameTimer === null) {
                setTimer()
            }
            //flip card up
...
function winner() {
    ...
    timeElapsed.innerHTML =
        `You won in ${minutes.innerHTML} min ${seconds0.innerHTML}${seconds1.innerHTML} seconds in ${playerMoves.innerHTML} moves!`
